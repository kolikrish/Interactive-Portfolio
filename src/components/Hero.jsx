    ...
    <section className={`relative z-[-1] w-full h-screen mx-auto banner overflow-hidden`}>
      ...
      >
        <div data-scroll data-scroll-speed='0.4'>
          <h1 className={`font-black lg:text-[90px] sm:text-[60px] xs:text-[50px] text-[40px] lg:leading-[98px] mt-40 text-white`}>
      ...
      <div className="sliderContainer md:z-[-10]">
        <div ref={slider} className="slider overflow-hidden text-secondary text-[10px] lg:text-[180px] mt-16">
